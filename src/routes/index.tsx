      ...
      <section id="top" className="relative min-h-[760px] pt-[76px] text-primary-foreground lg:min-h-[800px]">
        ...
        <div className="relative mx-auto flex min-h-[684px] max-w-7xl flex-col justify-end px-5 pb-10 lg:min-h-[724px] lg:px-10 lg:pb-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 inline-flex items-center gap-2 rounded-sm border border-accent/60 bg-accent/15 px-4 py-2.5 text-sm font-semibold tracking-wide text-secondary"><span className="size-1.5 shrink-0 rounded-full bg-secondary" />Always free — my planning comes at no cost to you, ever.</p>
